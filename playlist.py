...
song =  {'artist': (str), 'title': (str)}
Zoobalu = {'artist': 'Zoobalu Sue', 'title': 'You Know Who'}
add_song(my_playlist, Zoobalu)
'''
...
Ragnarok = {'artist': 'Randy Cornbiscuit', 'title': 'Where is all the wally-wonks'}
Demento = {'artist': 'Fooboo', 'title': 'Scooby-Doo'}
add_song(my_playlist, Ragnarok)
add_song(my_playlist, Demento)
